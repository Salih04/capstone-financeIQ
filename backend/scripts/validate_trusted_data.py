...
BACKEND_SRC = REPO_ROOT / "backend" if (REPO_ROOT / "backend").is_dir() else REPO_ROOT
FRONTEND_SRC = REPO_ROOT / "frontend" if (REPO_ROOT / "frontend").is_dir() else None
DATASETS = REPO_ROOT / "data/raw/yearly_xlsx"
...
SCAN_DIRS = [BACKEND_SRC / "app"]
if FRONTEND_SRC:
    SCAN_DIRS.append(FRONTEND_SRC / "src")
