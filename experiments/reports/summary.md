...
|:----------|:----------------------|:---------|-------:|-------:|-----------:|-----------------:|------------------------:|-----------------------:|------------------:|
| test_2023 | ridge                 | ml       | 127.6  | 167.44 |      0.167 |              0.4 |                  108.89 |                  44.38 |              0.65 |
...
| split     | model                 | kind     |    mae |   rmse |   spearman |   precision_at_5 |   top_bucket_avg_return |   median_actual_return |   directional_acc |
|:----------|:----------------------|:---------|-------:|-------:|-----------:|-----------------:|------------------------:|-----------------------:|------------------:|
| test_2024 | baseline_equal_weight | baseline |  45.97 |  57.01 |      0.074 |              0   |                   45.06 |                   35.4 |              0.5  |
| test_2024 | baseline_rank_score   | baseline |  45.97 |  57.01 |      0.074 |              0   |                   45.06 |                   35.4 |              0.5  |
| test_2024 | ridge                 | ml       |  99.6  | 125.59 |     -0.011 |              0.2 |                   20.86 |                   35.4 |              0.5  |
