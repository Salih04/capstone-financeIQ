...
- Accepted feature count: **40**
- Price/benchmark year-T features: `['benchmark_same_year_return_pct', 'price_adjclose_t', 'price_data_available', 'price_drawdown_from_3y_high_pct', 'price_history_years_available', 'price_momentum_1y_pct', 'price_momentum_2y_pct', 'price_vs_bist100_1y_pct']`
...
- target_columns: `['next_year_bist100_return_pct', 'next_year_excess_return_vs_bist100', 'next_year_outperform_bist100', 'next_year_rank_by_return', 'next_year_return_pct', 'next_year_return_percentile', 'next_year_top_10pct_returner', 'next_year_top_20pct_returner']`
- same_year_analysis_only: `['same_year_return_pct']`
- old_frozen_snapshot_columns: `['daily_change_pct', 'ebitda', 'ebitda_margin_pct', 'enterprise_value', 'ev_ebitda', 'ev_sales', 'fcf_financing', 'free_cash_flow', 'gross_margin_pct', 'gross_profit', 'icf', 'market_cap', 'net_income', 'net_margin_pct', 'ocf', 'operating_income', 'pb', 'pe', 'peg', 'price', 'return_1m_pct', 'return_1w_pct', 'return_1y_pct', 'return_3m_pct', 'return_3y_pct', 'return_5y_pct', 'return_6m_pct', 'return_ytd_pct', 'revenue', 'roa_pct', 'roe_pct', 'roic_pct', 'volume']`
- explicit_leakage_columns: `['day_return', 'period_return', 'price', 'return_1m', 'return_1w', 'return_1y', 'return_3m', 'return_3y', 'return_5y', 'return_6m', 'return_ytd', 'volume']`
- manual_rejected_features: `[]`