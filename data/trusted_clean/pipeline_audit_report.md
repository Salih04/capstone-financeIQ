...
- CSV files: **39**
- Files by class: `{'config': 3, 'other': 1, 'trusted_reference': 8, 'clean_generated': 4, 'modeling_ready': 1, 'public_modeling_ready': 1, 'training_modeling_ready': 1, 'raw': 20}`
...
| other | `data/provenance/cell_provenance_public_2020_2025.csv` | 14640 | 40 | 2020-2025 | 14400 | 0.2687 | `{}` |
...
| clean_generated | `data/trusted_clean/modeling_targets_alternative.csv` | 403 | 81 | 2020-2025 | 0 | 0.0916 | `{'next_year_nominal_try_return_pct_nonnull': 321, 'next_year_real_return_pct_nonnull': 321, 'next_year_usd_return_pct_nonnull': 321}` |
...
| raw | `data/trusted_raw/macro/cpi_yearly_tr.csv` | 6 |  | 2020-2025 |  | 0.0 | `{}` |
| raw | `data/trusted_raw/macro/macro_context_yearly.csv` | 6 |  | 2020-2025 |  | 0.0 | `{}` |
| raw | `data/trusted_raw/macro/usdtry_year_end.csv` | 6 |  | 2020-2025 |  | 0.1111 | `{}` |
