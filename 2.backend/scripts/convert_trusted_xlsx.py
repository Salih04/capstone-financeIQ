...
Usage:
    ...
    python -m scripts.convert_trusted_xlsx --datasets ../3.Datasets --out ../data/trusted
"""
...
# in Docker, where /app == 2.backend and the heuristic would be wrong.
DEFAULT_DATASETS = os.environ.get("TRUSTED_DATASETS_DIR", str(REPO_ROOT / "3.Datasets"))
